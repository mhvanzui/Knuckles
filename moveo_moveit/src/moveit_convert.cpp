...
int stepsPerRevolution[6] = {16800,12800,38400,1600,15800,0}; // 12800 + 4000,12800,38400,1600,12800 + 3000,0
// microsteps/steps (using 16ths) from observation, for each motor, applied by stepper driver
// original: 32800,18000,72000,3280,14400,0
// joint 1, joint 2, joint 3, joint 4, joint 5, gripper?
// 200 steps/revolution or 1.8 degrees for all motors except for the nema-14, which is 400 step/revolution
// assuming the 0 at the end is for the gripper motor?
