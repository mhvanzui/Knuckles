...
BaseRealSenseNode::BaseRealSenseNode(ros::NodeHandle& nodeHandle,
    ...
    _serial_no(serial_no), _base_frame_id("Link_5"),/*changed from "*blank*" to "Link_5"*/
...
void BaseRealSenseNode::getParameters()
{
    ...
    _pnh.param("base_frame_id", _base_frame_id, DEFAULT_BASE_FRAME_ID); // DEFAULT_BASE_FRAME_ID to "Link_5"
...
void BaseRealSenseNode::publishStaticTransforms()
{
    ...
    publish_static_tf(transform_ts_, zero_trans, quaternion{0, 0, 0, 1},"Link_5",_base_frame_id);
    publish_static_tf(transform_ts_, zero_trans, quaternion{0, 0, 0, 1}, _base_frame_id, _frame_id[DEPTH]);
// publish this line, connect to moveo tf link_5
